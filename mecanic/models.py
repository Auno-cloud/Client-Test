...
class Service(models.Model):
    ...
    description = models.TextField(blank=True, null=True, verbose_name="Descrição")
    price = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="Preço")
    delivery_time = models.IntegerField(verbose_name="Tempo de Entrega")
    delivery_time_unit = models.CharField(max_length=10, choices=delivery_time_choices, default='hj', verbose_name="Unidade de Tempo", help_text="Tempo de entrega " \
